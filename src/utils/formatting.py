...
def format_price(symbol: str, price: float) -> str:
    """
    Global helper function to format price.
    ...
    Returns:
        Formatted price string
    """
    return _global_formatter.format_price(symbol, price)


def format_quantity(symbol: str, quantity: float) -> str:
    """
    Global helper function to format quantity.
    ...
    Returns:
        Formatted quantity string
    """
    return _global_formatter.format_quantity(symbol, quantity)


def update_precision(symbol: str, price: float, quantity: float = None):
    """
    Global helper to update precision cache.
    ...
    Args:
        ...
        quantity: Observed quantity (optional)
    """
    _global_formatter.update_precision(symbol, price, quantity)
